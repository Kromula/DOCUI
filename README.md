...
Professional World of Warcraft UI setup with dedicated installer addon. Optimized for 1440p displays and Midnight (11.2.0+).
...
- **Healer Layout** - Raid frame focused for healing
...
3. Follow the patterns in PROFILE_IMPORT_GUIDE.md
4. Test thoroughly on PTR/Live
